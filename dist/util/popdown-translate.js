export function calcTranslateX(position, triggerRight, triggerLeft, offsetLeft, triggerWidth) {
...
export function calcTranslateY(position, triggerTop, offsetTop, triggerBottom, triggerHeight) {
